<div class="w-full  h-full relative md:w-[260px] bg-white rounded-lg shadow dark:bg-gray-800">
    <div class="whislist absolute top-1 right-1 z-40 flex items-center justify-center">
        <a   href="" class="inline-block w-full h-full bg-white p-2 rounded-full shadow-smbg-white">
    ...
    <div class="px-5 pb-5  mt-2 flex flex-col justify-between">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{(session()->has('userType') && session('userType') ==   'user') ? '/user/manage_cart/add/'.urlencode($cardData['name']).'/'.$cardData['id'] :  '/login'}}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
    </div>
</div>