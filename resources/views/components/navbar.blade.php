...
<nav class="bg-white border-gray-200 dark:bg-gray-900   md:px-8 shadow-sm  mb-12">
    ...
    <div class="flex justify-end md:justify-between w-2/3 flex-wrap items-center mx-auto">
      <div class="flex items-center">
        ...
        <div class="relative hidden md:block">
          ...
          <input type="text" id="search-navbar" class="block w-full  md:w-96 cursor-pointer p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Products...">
        </div>
      ...
      @if (session()->has('userType'))
      <div  class="ml-3 md:order-2">
        <x-user-profile-btn-drop-down  />
      </div>
      @endif
